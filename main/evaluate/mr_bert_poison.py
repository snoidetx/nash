...
DATASET_CONFIG_PATH = "main/configs/mr-bert_poison.yaml"
N_TRAIN = 8530
N_VAL = 1066
N_CLASSES = 2


def evaluate_mr_subset_poison(indices: List[int]=np.arange(N_TRAIN),
                       device=None,
                       seed=None):
    if not device:
