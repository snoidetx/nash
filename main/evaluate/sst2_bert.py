...
from main.models.mr import MRBert


DATASET_NAME = "sst2"
DATASET_CONFIG_PATH = "main/configs/sst2-bert.yaml"
N_TRAIN = 67349
N_VAL = 872
N_CLASSES = 2


def evaluate_sst2_subset(indices: List[int]=np.arange(N_TRAIN),
                       device=None,
                       seed=None):
    if not device:
